...
function load_research() {
	...
	var titulo1= canvas.append("text")
		...
		.append("tspan")
			.attr("x", x_pos1)
			.attr("dy", 0)
			.text("I have a PhD in Computer Science and Computational Mathematics from the Institute of Mathematics and Computer")
		.append("tspan")
			.attr("x", x_pos1)
			.attr("dy", dy)
			.text(" Science at the University of São Paulo (ICMC-USP), São Carlos, SP, Brazil, where I am a member of the Graphics, ")
		.append("tspan")
			.attr("x", x_pos1)
			.attr("dy", dy)
			.text("Imaging, Visualization, and Analytics group (GIVA) and develop research in explainable artificial intelligence (XAI) ")
		.append("tspan")
			.attr("x", x_pos1)
			.attr("dy", dy)
		...
		.append("tspan")
			.attr("x", x_pos1)
			.attr("dy", dy)
			.text("I also have a Bachelor's (2015) and a Master's (2018) degree in Computer Science from the ICMC-USP, where I ")
		.append("tspan")
			.attr("x", x_pos1)
			.attr("dy", dy)
			.text("acquired experience in multidimensional time-series analysis and visualization. My research interests include (but ")
		.append("tspan")
			.attr("x", x_pos1)
			.attr("dy", dy)
			.text("are not limited to) XAI, machine learning, data science, data mining, information visualization (InfoVis), and image ")
		.append("tspan")
			.attr("x", x_pos1)
			.attr("dy", dy)
			.text("processing. I also have experience in C, C++, Java, JavaScript, D3.js, and Python programming.")
